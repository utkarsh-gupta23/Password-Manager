...
class CredentialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credential" do
    assert_difference("Credential.count") do
      post credentials_url, params: { credential: { password: @credential.password, title: @credential.title, user_id: @credential.user_id, username: @credential.username, website: @credential.website } }
    end
  ...
  test "should update credential" do
    patch credential_url(@credential), params: { credential: { password: @credential.password, title: @credential.title, user_id: @credential.user_id, username: @credential.username, website: @credential.website } }
