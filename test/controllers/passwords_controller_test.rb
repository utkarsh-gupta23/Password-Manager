...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference("Password.count") do
      post passwords_url, params: { password: { Home: @password.Home, controller: @password.controller, g: @password.g, rails: @password.rails } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { Home: @password.Home, controller: @password.controller, g: @password.g, rails: @password.rails } }
